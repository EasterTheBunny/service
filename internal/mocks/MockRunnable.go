...
func (_m *MockRunnable) Shutdown() error {
	ret := _m.Called()
...
func (_e *MockRunnable_Expecter) Shutdown() *MockRunnable_Shutdown_Call {
	return &MockRunnable_Shutdown_Call{Call: _e.mock.On("Shutdown")}
}

func (_c *MockRunnable_Shutdown_Call) Run(run func()) *MockRunnable_Shutdown_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockRunnable_Shutdown_Call) RunAndReturn(run func() error) *MockRunnable_Shutdown_Call {
	_c.Call.Return(run)
	return _c
}
